...
//         e.preventDefault();
//         try {
//             const res = await axios.post(`http://localhost:5037/api/User/register`, {
...
//                             error={!!error}/>
//                     <TextField type='text' fullWidth label='FullName' variant="outlined" inputRef={nameRef} required
//                             error={!!error} />                 
...
//         `http://localhost:5037/api/User/register`,
//         {
//           Name: nameRef.current?.value,
//           PasswordHash: passwordRef.current?.value,
//           Email: emailRef.current?.value,
